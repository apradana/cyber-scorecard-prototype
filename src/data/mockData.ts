...
const TREND_CRIT: TrendData = {
  ...
  '90d': [60,62,62,64,65,66,67,68,69,70,71,72,73,75,76,78],
...
const TREND_WARN: TrendData = {
  ...
  '90d': [64,63,62,62,61,61,60,60,59,59,58,58,57,57,57,56],
...
const TREND_SAFE: TrendData = {
  ...
  '90d': [54,51,48,45,43,40,38,36,34,32,30,28,27,26,25,24],
